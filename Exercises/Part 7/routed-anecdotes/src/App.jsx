...
const SelectedAnecdote = ({ anecdotes }) => {
  ...
  return (
    <>
      <div style={bold}>{anecdote.content} by {anecdote.author}</div>
...
const App = () => {
  ...
  console.log("0:" + anecdotes[0].content)
  return (
    <Router>
      <div>
        ...
        <Routes>
          ...
          <Route path={`/anecdote/:id`} element={<SelectedAnecdote anecdotes={anecdotes} />} ></Route>
        </Routes>
        <Footer />
      </div>
    </Router>
